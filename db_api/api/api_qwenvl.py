...
# image_path: str这种语法被称为类型注解（Type Annotation）。
            ...
            "content": [
                ...
                },
                {
                    "text": f'''What is in this image? 
                               Please describe the content of this image in concise English text.
                               I just need you to return the description text 
                               and not to locate the specific content within the image.
                            '''
                },
                {
